...
function SWEP:Equip( NewOwner )
	if not snd_portal2:GetBool() then
		self:EmitSound( "weapons/portalgun/portalgun_powerup1.wav", 70, 100, .7, CHAN_WEAPON )
	else
		self:EmitSound( "weapons/portalgun/portal2/portalgun_powerup1.wav", 70, 100, .7, CHAN_WEAPON )
	end
end
