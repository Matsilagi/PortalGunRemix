...
local dlightenabled = CreateClientConVar("portal_dynamic_light", "0", true, true) --Pretty laggy, default it to off
-- local lightteleport = CreateClientConVar("portal_light_teleport", "0", true, true)
local bordersenabled = CreateClientConVar("portal_borders", "1", true, true)
local renderportals = CreateClientConVar("portal_render", 1, true, true) --Some people can't handle portals at all.
local texFSBportals = CreateClientConVar("portal_texFSB", 0, true, true)

CreateClientConVar("portal_color_1", 7, true, true)
CreateClientConVar("portal_color_contraste_1", 1, true, true)
CreateClientConVar("portal_color_saturation_1", 0, true, true)

CreateClientConVar("portal_color_2", 1, true, true)
CreateClientConVar("portal_color_contraste_2", 1, true, true)
CreateClientConVar("portal_color_saturation_2", 0, true, true)
...
local PortalMaterial = CreateMaterial( "PortalMaterial",
	"UnlitGeneric", -- "GMODScreenspace",
	{
		[ "$basetexture" ] = texFSB,
		[ "$model" ] = "1",
					...
					elseif GetConVarNumber("portal_color_2") >=11 then
						if GetConVarNumber("portal_color_contraste_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink2_light )
							end
						elseif GetConVarNumber("portal_color_contraste_2") >=1 then 
							if GetConVarNumber("portal_color_saturation_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink2 )
							end
						else
							if GetConVarNumber("portal_color_saturation_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink2_dark )
							end
						end
					elseif GetConVarNumber("portal_color_2") >=10 then
						if GetConVarNumber("portal_color_contraste_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink_light )
							end
						elseif GetConVarNumber("portal_color_contraste_2") >=1 then 
							if GetConVarNumber("portal_color_saturation_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink )
							end
						else
							if GetConVarNumber("portal_color_saturation_2") >=2 then 
							...
							elseif GetConVarNumber("portal_color_saturation_2") >=1 then 
								...
								surface.SetTexture( two_portals_pink_dark )
							end
						end
					elseif GetConVarNumber("portal_color_2") >=9 then
						if GetConVarNumber("portal_color_contraste_2") >=2 then 
